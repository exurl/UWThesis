...
\begin{table}[H]
	...
	\begin{tabular}{cccccccccc}
		...
		13 & 5 & 2 & 1    & manual tune   & no  & 227 & 486  & 713 \\
		14 & 5 & 2 & 1e3  & manual tune   & no  & 176 & 912  & 5607 \\
		15 & 5 & 2 & 1e-3 & manual tune   & no  & 347 & 408  & 1292 \\
		\hline\hline
	\end{tabular}
\end{table}
...
%	\centering
%	\label{tab:optVars}
%	\caption{Model Tuning Optimized Parameters}
%	\begin{tabular}{}
%		\hline\hline
